...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject boar_Prefab, zombie_Prefab, zombie2_Prefab; 
    [SerializeField] private int zombie_Enemy_Count, boar_Enemy_Count, zombie2_Enemy_Count;
